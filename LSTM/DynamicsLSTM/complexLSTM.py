...
def randomDataGenerator(n_examples, n_features, n_timesteps, delta_t):
...
# randomDataGenerator(n_examples,3,10000,.01)
  
#Train
for e in range(n_epoch):
    X,y = randomDataGenerator(n_examples,3,n_timesteps,delta_t)
